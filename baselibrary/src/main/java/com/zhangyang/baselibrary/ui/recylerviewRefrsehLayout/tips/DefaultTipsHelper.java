...
import com.zhangyang.baselibrary.ui.fragment.BaseMvpRecylerviewFragment;
import com.zhangyang.baselibrary.utils.DensityUtil;

public class DefaultTipsHelper implements TipsHelper {

    protected final BaseMvpRecylerviewFragment mFragment;
    protected final RecyclerView mRecyclerView;
    protected final RecyclerRefreshLayout mRefreshLayout;
    protected final ImageView mLoadingView;

    public DefaultTipsHelper(BaseMvpRecylerviewFragment fragment) {
        mFragment = fragment;
